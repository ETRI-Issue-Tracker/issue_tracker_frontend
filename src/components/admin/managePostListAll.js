...
export default function ManagePostListAll() {
  ...
  const postClickHandler = (e) => {
    ...
    if (e.target.type !== 'submit') navigate(`/post/${postId}?manage=true&prev=all`);
  };
...
const Style = {
  ...
  TableData: styled.td`
    ...
    white-space: nowrap;
    overflow: hidden;
    max-width: ${(props) => (props.width ? props.width + 'px' : 100 + 'px')};
    height: 24px;
    padding: 8px;
  `,
